...
namespace RScript.Addin.App
{
    ...
    public class RevitExternalApp : IExternalApplication
    {
        ...
        private static RevitScriptServer _server;
        ...
        public static RevitScriptServer Server => _server;
        public static void SetServer(RevitScriptServer server) => _server = server;
